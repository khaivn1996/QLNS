...
$truyvanMaLHDT = "
SELECT
CASE WHEN CHAR_LENGTH(CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))=1 
THEN 
	CONCAT('DT000',CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))
ELSE 
	CASE WHEN CHAR_LENGTH(CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))=2
    THEN
    	CONCAT('DT00',CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))
    ELSE
    	CASE WHEN CHAR_LENGTH(CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))=3
    	THEN
    		CONCAT('DT0',CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))
    	ELSE
    		CONCAT('DT',CONVERT(CONVERT(RIGHT(MaLHDT,4),UNSIGNED)+1,CHAR))
    	END
    END
...
<body>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function LoadData(){
				$.ajax({
					url: "<?php echo $HomeURL; ?>/loaihinhdaotao/ajax_xuly.php",
					method: "POST",
			...
			$(document).on('click','.edit_data',function(){
				...
				$.ajax({
					url: "<?php echo $HomeURL; ?>/loaihinhdaotao/edit.php",
					method: "POST",
					dataType: "json",
					data:{MaLHDT:MaLHDT},
					success:function(data){
			...
			$('#edit_LHDT').on('submit',function(event){
				...
				if ($('#MaLHDT').val()=='') {
					...
					$.ajax({
						url: "<?php echo $HomeURL; ?>/loaihinhdaotao/ajax_sua.php",
						method: "POST",
