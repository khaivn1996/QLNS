    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" id="nhanvien_page" aria-current="page" href="http://localhost:8080/QLNS/nhanvien/index.php">
              <span data-feather="users"></span>
              NHÂN VIÊN
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="donvi_page" href="http://localhost:8080/QLNS/donvi/index.php">
              <span data-feather="grid"></span>
              ĐƠN VỊ
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="bangcap_page" href="http://localhost:8080/QLNS/bangcap/index.php">
              <span data-feather="file-text"></span>
              MÃ BẰNG CẤP
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="daotao_page" href="http://localhost:8080/QLNS/loaihinhdaotao/index.php">
              <span data-feather="layers"></span>
              LOẠI HÌNH ĐÀO TẠO
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="hoctap_page" href="http://localhost:8080/QLNS/qthoctap/index.php">
              <span data-feather="activity"></span>
              QUÁ TRÌNH HỌC TẬP
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="congtac_page" href="http://localhost:8080/QLNS/qtcongtac/index.php">
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            <a class="nav-link" id="danhmuc_page" href="http://localhost:8080/QLNS/danhmucKTKL/index.php">
              <span data-feather="menu"></span>
              DANH MỤC
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="cap_page" href="http://localhost:8080/QLNS/capKTKL/index.php">
              <span data-feather="award"></span>
              CẤP
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="chitiet_page" href="http://localhost:8080/QLNS/chitietKTKL/index.php">
              <span data-feather="file-text"></span>
              CHI TIẾT
            </a>
          </li>
