...
<head>
    ...
    <style type="text/css">
        body {
          ...
          background-image:url('<?php echo $HomeURL; ?>/res/image/bg_login.jpg');
        ...
        <div class="col-md-offset-4 col-md-4 text-center">
            ...
            <form action="../index.php" id="dangnhapform" method="post">
                <div class="form-login"></br>
                    ...
                    <i><a href="<?php echo $HomeURL; ?>/admin/dangky.php">Bạn chưa có tài khoản? Vui lòng đăng ký tại đây.</a></i>
                </div>
            </form>
        </div>
    </div>
