...
<body>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function LoadData(){
				$.ajax({
					url: "http://localhost:8080/QLNS/chitietKTKL/ajax_xuly.php",
					method: "POST",
			...
			$(document).on('click','.edit_data',function(){
				...
				$.ajax({
					url: "http://localhost:8080/QLNS/chitietKTKL/edit.php",
					method: "POST",
					dataType: "json",
					data:{SoHieu:SoHieu},
					success:function(data){
			...
			$('#edit_KTKL').on('submit',function(event){
				...
				if ($('#MaNV').val()=='') {
					...
					$.ajax({
						url: "http://localhost:8080/QLNS/chitietKTKL/ajax_sua.php",
						method: "POST",
