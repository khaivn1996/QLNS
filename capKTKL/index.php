...
$truyvanMaC = "
SELECT
CASE WHEN CHAR_LENGTH(CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))=1 
THEN 
	CONCAT('CA000',CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))
ELSE 
	CASE WHEN CHAR_LENGTH(CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))=2
    THEN
    	CONCAT('CA00',CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))
    ELSE
    	CASE WHEN CHAR_LENGTH(CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))=3
    	THEN
    		CONCAT('CA0',CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))
    	ELSE
    		CONCAT('CA',CONVERT(CONVERT(RIGHT(MaCapKTKL,4),int)+1,CHAR))
    	END
    END
...
<body>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function LoadData(){
				$.ajax({
					url: "http://localhost:8080/QLNS/capKTKL/ajax_xuly.php",
					method: "POST",
			...
			$(document).on('click','.edit_data',function(){
				...
				$.ajax({
					url: "http://localhost:8080/QLNS/capKTKL/edit.php",
					method: "POST",
					dataType: "json",
			...
			$('#edit_CapKTKL').on('submit',function(event){
				...
				if ($('#MaCapKTKL').val()=='') {
					...
					$.ajax({
						url: "http://localhost:8080/QLNS/capKTKL/ajax_sua.php",
						method: "POST",
